#!/bin/bash
#SBATCH --job-name=cf_dqn_batch_06
...
# GPU 0: Asterix, seed=3, n_freq=32, max=2
...
# GPU 1: Asterix, seed=3, n_freq=32, max=5
...
# GPU 2: Asterix, seed=3, n_freq=64, max=2
...
# GPU 3: Asterix, seed=3, n_freq=64, max=5
