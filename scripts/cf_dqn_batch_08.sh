#!/bin/bash
#SBATCH --job-name=cf_dqn_batch_08
...
# GPU 0: Seaquest, seed=2, n_freq=32, max=2
CUDA_VISIBLE_DEVICES=0 python cleanrl/cf_dqn_atari.py \
    --env-id SeaquestNoFrameskip-v4 \
    --track \
    --wandb-project-name CF-DQN-Seaquest \
    --exp-name cf_dqn_freq32_max2_seed2 \
    --seed 2 \
    --n-frequencies 32 \
    --freq-max 2.0 \
    --collapse-max-w 1.0 \
...
# GPU 1: Seaquest, seed=2, n_freq=32, max=5
CUDA_VISIBLE_DEVICES=1 python cleanrl/cf_dqn_atari.py \
    --env-id SeaquestNoFrameskip-v4 \
    --track \
    --wandb-project-name CF-DQN-Seaquest \
    --exp-name cf_dqn_freq32_max5_seed2 \
    --seed 2 \
    --n-frequencies 32 \
    --freq-max 5.0 \
    --collapse-max-w 1.0 \
...
# GPU 2: Seaquest, seed=2, n_freq=64, max=2
CUDA_VISIBLE_DEVICES=2 python cleanrl/cf_dqn_atari.py \
    --env-id SeaquestNoFrameskip-v4 \
    --track \
    --wandb-project-name CF-DQN-Seaquest \
    --exp-name cf_dqn_freq64_max2_seed2 \
    --seed 2 \
    --n-frequencies 64 \
    --freq-max 2.0 \
    --collapse-max-w 1.0 \
...
# GPU 3: Seaquest, seed=2, n_freq=64, max=5
CUDA_VISIBLE_DEVICES=3 python cleanrl/cf_dqn_atari.py \
    --env-id SeaquestNoFrameskip-v4 \
    --track \
    --wandb-project-name CF-DQN-Seaquest \
    --exp-name cf_dqn_freq64_max5_seed2 \
    --seed 2 \
    --n-frequencies 64 \
    --freq-max 5.0 \
    --collapse-max-w 1.0 \
