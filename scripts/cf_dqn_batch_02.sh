#!/bin/bash
#SBATCH --job-name=cf_dqn_batch_02
...
# GPU 0: Breakout, seed=2, n_freq=32, max=2
...
# GPU 1: Breakout, seed=2, n_freq=32, max=5
...
# GPU 2: Breakout, seed=2, n_freq=64, max=2
...
# GPU 3: Breakout, seed=2, n_freq=64, max=5
