#!/bin/bash
#SBATCH --job-name=cf_dqn_batch_09
...
# GPU 0: Seaquest, seed=3, n_freq=32, max=2
...
# GPU 1: Seaquest, seed=3, n_freq=32, max=5
...
# GPU 2: Seaquest, seed=3, n_freq=64, max=2
...
# GPU 3: Seaquest, seed=3, n_freq=64, max=5
