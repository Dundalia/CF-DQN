#!/bin/bash
#SBATCH --job-name=cf_dqn_batch_12
...
# GPU 0: Qbert, seed=3, n_freq=32, max=2
...
# GPU 1: Qbert, seed=3, n_freq=32, max=5
...
# GPU 2: Qbert, seed=3, n_freq=64, max=2
...
# GPU 3: Qbert, seed=3, n_freq=64, max=5
