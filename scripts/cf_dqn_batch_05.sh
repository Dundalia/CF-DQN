#!/bin/bash
#SBATCH --job-name=cf_dqn_batch_05
...
# GPU 1: Asterix, seed=2, n_freq=32, max=5
...
# GPU 2: Asterix, seed=2, n_freq=64, max=2
...
# GPU 3: Asterix, seed=2, n_freq=64, max=5
