...
# GPU 0: Breakout, seed=1
CUDA_VISIBLE_DEVICES=0 python cleanrl/c51_atari.py \
...
# GPU 1: Asterix, seed=1
CUDA_VISIBLE_DEVICES=1 python cleanrl/c51_atari.py \
...
# GPU 2: Seaquest, seed=1
CUDA_VISIBLE_DEVICES=2 python cleanrl/c51_atari.py \
...
# GPU 3: Qbert, seed=1
CUDA_VISIBLE_DEVICES=3 python cleanrl/c51_atari.py \
